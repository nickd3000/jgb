...
public class Utils {
    ...
    public static void ReadFileBytesToMemoryLocation(String fileName, int[] memoryDevice, int targetLocation) /*throws IOException*/ {
...
//                }
    ...
    public static int ReadPrgFileBytesToMemoryLocation(String fileName, CPU cpu, int targetLocation) throws IOException {
        FileInputStream in = null;
        int loc = 0;
        try {
    ...
    public static void logIoAccess(int addr, String strVal, String prefix) {
        ...
        if (addr >= 0xD000 && addr <= 0xD3FF)
            System.out.println(prefix + " VIC-II registers addr:" + strAddress + strVal);

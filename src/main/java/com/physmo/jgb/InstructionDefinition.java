...
enum COMMAND {
    NOP, LD, INC, XOR, LDD, LDI, PREFIX, JRNZ, LDZPGCA, LDZPGNNA, LDAZPGNN, CALL, PUSHW, POPW, RLA, DEC, DECW, JP, DI, EI, INCW, RET, CP, OR, AND, CPL, JRZ, JR, SUB, ADD, HALT,
...
public enum InstructionDefinition {
    ...
    STOP(0x10, COMMAND.STOP, 1, ADDRMODE.NONE, ADDRMODE.NONE), // TEST

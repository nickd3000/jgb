...
enum COMMAND {
	...
	, INCW, RET, CP, OR, AND, CPL,JRZ,JR,SUB,ADD,
	RST_38H, RST_8H, RETZ, RETNZ, JRNC, JRC, ADC, SBC, JPZ, RRCA, ADDHL, RETNC, CALLNZ, RETI, JPNZ, LDHLSPN, RST_28H, RLCA, JPNC, CALLZ, SCF, CALLC, RST_00H,
};
...
public enum InstructionDefinition {
	...
	CP_nn(0xFE, COMMAND.CP, 1, ADDRMODE.nn, ADDRMODE.NONE),	// FE    CP   nn

...
enum COMMAND {
	...
	RST_38H, RST_8H, RETZ, RETNZ, JRNC, JRC, ADC, SBC, JPZ, RRCA, ADDHL, RETNC, CALLNZ, RETI, JPNZ, LDHLSPN, RST_28H, RLCA, JPNC, CALLZ, SCF, CALLC, RST_00H, RR, JPC, RST_20H, RETC, RST_18H, DAA, RST_30H, RST_10H, CCF, LDAZPGC, ADDSPNN,
};
